...
R2GC_163_5 = Coupling(name = 'R2GC_163_5',
                      value = '(complex(0,1)*G**2*MB*sa*yb)/(8.*cb*cmath.pi**2*cmath.sqrt(2))',
                      order = {'QCD':2,'QED':1})
...
R2GC_164_7 = Coupling(name = 'R2GC_164_7',
                      value = '-(ca*complex(0,1)*G**2*MB*yb)/(8.*cb*cmath.pi**2*cmath.sqrt(2))',
                      order = {'QCD':2,'QED':1})
...
R2GC_166_11 = Coupling(name = 'R2GC_166_11',
                       value = '-(complex(0,1)*G**2*sa**2*yb**2)/(16.*cb**2*cmath.pi**2)',
                       order = {'QCD':2,'QED':2})
...
R2GC_168_15 = Coupling(name = 'R2GC_168_15',
                       value = '(ca*complex(0,1)*G**2*sa*yb**2)/(16.*cb**2*cmath.pi**2)',
                       order = {'QCD':2,'QED':2})
...
R2GC_169_17 = Coupling(name = 'R2GC_169_17',
                       value = '-(ca**2*complex(0,1)*G**2*yb**2)/(16.*cb**2*cmath.pi**2)',
                       order = {'QCD':2,'QED':2})
...
R2GC_237_70 = Coupling(name = 'R2GC_237_70',
                       value = '(ca*complex(0,1)*G**2*yb)/(3.*cb*cmath.pi**2*cmath.sqrt(2))',
                       order = {'QCD':2,'QED':1})

R2GC_238_71 = Coupling(name = 'R2GC_238_71',
                       value = '-(complex(0,1)*G**2*sa*yb)/(3.*cb*cmath.pi**2*cmath.sqrt(2))',
                       order = {'QCD':2,'QED':1})
...
UVGC_237_51 = Coupling(name = 'UVGC_237_51',
                       value = {-1:'( (ca*complex(0,1)*G**2*yb)/(6.*cb*cmath.pi**2*cmath.sqrt(2)) if MB else -(ca*complex(0,1)*G**2*yb)/(12.*cb*cmath.pi**2*cmath.sqrt(2)) ) + (ca*complex(0,1)*G**2*yb)/(3.*cb*cmath.pi**2*cmath.sqrt(2))',0:'( (3*ca*complex(0,1)*G**2*yb)/(4.*cb*cmath.pi**2*cmath.sqrt(2)) - (ca*complex(0,1)*G**2*yb*reglog(MB/MU_R))/(cb*cmath.pi**2*cmath.sqrt(2)) if MB else (ca*complex(0,1)*G**2*yb)/(12.*cb*cmath.pi**2*cmath.sqrt(2)) ) - (ca*complex(0,1)*G**2*yb)/(12.*cb*cmath.pi**2*cmath.sqrt(2))'},
                       order = {'QCD':2,'QED':1})

UVGC_238_52 = Coupling(name = 'UVGC_238_52',
                       value = {-1:'( -(complex(0,1)*G**2*sa*yb)/(6.*cb*cmath.pi**2*cmath.sqrt(2)) if MB else (complex(0,1)*G**2*sa*yb)/(12.*cb*cmath.pi**2*cmath.sqrt(2)) ) - (complex(0,1)*G**2*sa*yb)/(3.*cb*cmath.pi**2*cmath.sqrt(2))',0:'( (-3*complex(0,1)*G**2*sa*yb)/(4.*cb*cmath.pi**2*cmath.sqrt(2)) + (complex(0,1)*G**2*sa*yb*reglog(MB/MU_R))/(cb*cmath.pi**2*cmath.sqrt(2)) if MB else -(complex(0,1)*G**2*sa*yb)/(12.*cb*cmath.pi**2*cmath.sqrt(2)) ) + (complex(0,1)*G**2*sa*yb)/(12.*cb*cmath.pi**2*cmath.sqrt(2))'},
                       order = {'QCD':2,'QED':1})
