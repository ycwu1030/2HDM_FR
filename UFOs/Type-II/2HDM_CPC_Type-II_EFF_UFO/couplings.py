...
GC_209 = Coupling(name = 'GC_209',
                  value = '-((ca*complex(0,1)*ydo)/(cb*cmath.sqrt(2)))',
                  order = {'QED':1})

GC_210 = Coupling(name = 'GC_210',
                  value = '(complex(0,1)*sa*ydo)/(cb*cmath.sqrt(2))',
                  order = {'QED':1})
...
GC_225 = Coupling(name = 'GC_225',
                  value = '-((ca*complex(0,1)*ys)/(cb*cmath.sqrt(2)))',
                  order = {'QED':1})

GC_226 = Coupling(name = 'GC_226',
                  value = '(complex(0,1)*sa*ys)/(cb*cmath.sqrt(2))',
                  order = {'QED':1})
