...
V_119 = Vertex(name = 'V_119',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_72,(0,1):C.GC_54})

V_120 = Vertex(name = 'V_120',
               particles = [ P.t__tilde__, P.s, P.H__plus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_73,(0,1):C.GC_55})

V_121 = Vertex(name = 'V_121',
               particles = [ P.u__tilde__, P.b, P.H__plus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_74,(0,1):C.GC_56})

V_122 = Vertex(name = 'V_122',
               particles = [ P.c__tilde__, P.b, P.H__plus__ ],
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_75,(0,1):C.GC_57})
...
V_167 = Vertex(name = 'V_167',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_63,(0,1):C.GC_81})
...
V_169 = Vertex(name = 'V_169',
               ...
               color = [ 'Identity(1,2)' ],
               lorentz = [ L.FFS1, L.FFS3 ],
               couplings = {(0,0):C.GC_65,(0,1):C.GC_83})
