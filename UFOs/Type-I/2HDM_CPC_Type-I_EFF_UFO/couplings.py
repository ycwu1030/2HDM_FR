...
GC_214 = Coupling(name = 'GC_214',
                  value = '-((ca*complex(0,1)*ye)/(sb*cmath.sqrt(2)))',
                  order = {'QED':1})
...
GC_217 = Coupling(name = 'GC_217',
                  value = '-((complex(0,1)*sa*ye)/(sb*cmath.sqrt(2)))',
                  order = {'QED':1})
...
GC_220 = Coupling(name = 'GC_220',
                  value = '-((ca*complex(0,1)*ym)/(sb*cmath.sqrt(2)))',
                  order = {'QED':1})
...
GC_223 = Coupling(name = 'GC_223',
                  value = '-((complex(0,1)*sa*ym)/(sb*cmath.sqrt(2)))',
                  order = {'QED':1})
