...
R2GC_163_5 = Coupling(name = 'R2GC_163_5',
                      value = '-(cb*cba*complex(0,1)*G**2*MB*yb)/(8.*cmath.pi**2*sb*cmath.sqrt(2)) - (complex(0,1)*G**2*MB*sba*yb)/(8.*cmath.pi**2*cmath.sqrt(2))',
                      order = {'QCD':2,'QED':1})
...
R2GC_164_7 = Coupling(name = 'R2GC_164_7',
                      value = '-(cba*complex(0,1)*G**2*MB*yb)/(8.*cmath.pi**2*cmath.sqrt(2)) + (cb*complex(0,1)*G**2*MB*sba*yb)/(8.*cmath.pi**2*sb*cmath.sqrt(2))',
                      order = {'QCD':2,'QED':1})
...
R2GC_168_15 = Coupling(name = 'R2GC_168_15',
                       value = '-(cb**2*cba**2*complex(0,1)*G**2*yb**2)/(16.*cmath.pi**2*sb**2) - (cb*cba*complex(0,1)*G**2*sba*yb**2)/(8.*cmath.pi**2*sb) - (complex(0,1)*G**2*sba**2*yb**2)/(16.*cmath.pi**2)',
                       order = {'QCD':2,'QED':2})
...
R2GC_169_17 = Coupling(name = 'R2GC_169_17',
                       value = '-(cba**2*complex(0,1)*G**2*yb**2)/(16.*cmath.pi**2) + (cb*cba*complex(0,1)*G**2*sba*yb**2)/(8.*cmath.pi**2*sb) - (cb**2*complex(0,1)*G**2*sba**2*yb**2)/(16.*cmath.pi**2*sb**2)',
                       order = {'QCD':2,'QED':2})
...
R2GC_170_19 = Coupling(name = 'R2GC_170_19',
                       value = '-(cb*cba**2*complex(0,1)*G**2*yb**2)/(16.*cmath.pi**2*sb) - (cba*complex(0,1)*G**2*sba*yb**2)/(16.*cmath.pi**2) + (cb**2*cba*complex(0,1)*G**2*sba*yb**2)/(16.*cmath.pi**2*sb**2) + (cb*complex(0,1)*G**2*sba**2*yb**2)/(16.*cmath.pi**2*sb)',
                       order = {'QCD':2,'QED':2})
...
R2GC_238_71 = Coupling(name = 'R2GC_238_71',
                       value = '(cb*cba*complex(0,1)*G**2*yb)/(3.*cmath.pi**2*sb*cmath.sqrt(2)) + (complex(0,1)*G**2*sba*yb)/(3.*cmath.pi**2*cmath.sqrt(2))',
                       order = {'QCD':2,'QED':1})

R2GC_239_72 = Coupling(name = 'R2GC_239_72',
                       value = '(cba*complex(0,1)*G**2*yb)/(3.*cmath.pi**2*cmath.sqrt(2)) - (cb*complex(0,1)*G**2*sba*yb)/(3.*cmath.pi**2*sb*cmath.sqrt(2))',
                       order = {'QCD':2,'QED':1})
...
UVGC_238_52 = Coupling(name = 'UVGC_238_52',
                       value = {-1:'( (cb*cba*complex(0,1)*G**2*yb)/(6.*cmath.pi**2*sb*cmath.sqrt(2)) + (complex(0,1)*G**2*sba*yb)/(6.*cmath.pi**2*cmath.sqrt(2)) if MB else -(cb*cba*complex(0,1)*G**2*yb)/(12.*cmath.pi**2*sb*cmath.sqrt(2)) - (complex(0,1)*G**2*sba*yb)/(12.*cmath.pi**2*cmath.sqrt(2)) ) + (cb*cba*complex(0,1)*G**2*yb)/(3.*cmath.pi**2*sb*cmath.sqrt(2)) + (complex(0,1)*G**2*sba*yb)/(3.*cmath.pi**2*cmath.sqrt(2))',0:'( (3*cb*cba*complex(0,1)*G**2*yb)/(4.*cmath.pi**2*sb*cmath.sqrt(2)) + (3*complex(0,1)*G**2*sba*yb)/(4.*cmath.pi**2*cmath.sqrt(2)) - (cb*cba*complex(0,1)*G**2*yb*reglog(MB/MU_R))/(cmath.pi**2*sb*cmath.sqrt(2)) - (complex(0,1)*G**2*sba*yb*reglog(MB/MU_R))/(cmath.pi**2*cmath.sqrt(2)) if MB else (cb*cba*complex(0,1)*G**2*yb)/(12.*cmath.pi**2*sb*cmath.sqrt(2)) + (complex(0,1)*G**2*sba*yb)/(12.*cmath.pi**2*cmath.sqrt(2)) ) - (cb*cba*complex(0,1)*G**2*yb)/(12.*cmath.pi**2*sb*cmath.sqrt(2)) - (complex(0,1)*G**2*sba*yb)/(12.*cmath.pi**2*cmath.sqrt(2))'},
                       order = {'QCD':2,'QED':1})

UVGC_239_53 = Coupling(name = 'UVGC_239_53',
                       value = {-1:'( (cba*complex(0,1)*G**2*yb)/(6.*cmath.pi**2*cmath.sqrt(2)) - (cb*complex(0,1)*G**2*sba*yb)/(6.*cmath.pi**2*sb*cmath.sqrt(2)) if MB else -(cba*complex(0,1)*G**2*yb)/(12.*cmath.pi**2*cmath.sqrt(2)) + (cb*complex(0,1)*G**2*sba*yb)/(12.*cmath.pi**2*sb*cmath.sqrt(2)) ) + (cba*complex(0,1)*G**2*yb)/(3.*cmath.pi**2*cmath.sqrt(2)) - (cb*complex(0,1)*G**2*sba*yb)/(3.*cmath.pi**2*sb*cmath.sqrt(2))',0:'( (3*cba*complex(0,1)*G**2*yb)/(4.*cmath.pi**2*cmath.sqrt(2)) - (3*cb*complex(0,1)*G**2*sba*yb)/(4.*cmath.pi**2*sb*cmath.sqrt(2)) - (cba*complex(0,1)*G**2*yb*reglog(MB/MU_R))/(cmath.pi**2*cmath.sqrt(2)) + (cb*complex(0,1)*G**2*sba*yb*reglog(MB/MU_R))/(cmath.pi**2*sb*cmath.sqrt(2)) if MB else (cba*complex(0,1)*G**2*yb)/(12.*cmath.pi**2*cmath.sqrt(2)) - (cb*complex(0,1)*G**2*sba*yb)/(12.*cmath.pi**2*sb*cmath.sqrt(2)) ) - (cba*complex(0,1)*G**2*yb)/(12.*cmath.pi**2*cmath.sqrt(2)) + (cb*complex(0,1)*G**2*sba*yb)/(12.*cmath.pi**2*sb*cmath.sqrt(2))'},
                       order = {'QCD':2,'QED':1})
...
UVGC_260_106 = Coupling(name = 'UVGC_260_106',
...
UVGC_260_107 = Coupling(name = 'UVGC_260_107',
